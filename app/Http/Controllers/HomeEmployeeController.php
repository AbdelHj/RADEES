...
class HomeEmployeeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $accepter = AdvanceRequest::where('etat', '1')->where('employee_id', $user->id)->count();
        $refuser = AdvanceRequest::where('etat', '0')->where('employee_id', $user->id)->count();
        $traitment = AdvanceRequest::where('etat', NULL)->where('employee_id', $user->id)->count();


        $count = AdvanceRequest::where('employee_id', $user->id)->count();
